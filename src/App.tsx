...
// Utilities
import {
	  createBoard, findEmptyPosition, isValidMove, isWinningState, makeMove, shuffleBoard
...
function App(): ReactElement {
	...
	const onHandleTileClick = useCallback((position: Position): void => {
			...
			if (isValidMove(position, emptyPos)) {
				  ...
				  setGameState(previous => ({
					    ...previous,
					moves: previous.moves + MOVE_INCREMENT,
					isWon: isWinningState(updatedBoard),
					isPlaying: !isWinningState(updatedBoard)
				}))
			}
		},
		[board, gameState.isWon]
	)
